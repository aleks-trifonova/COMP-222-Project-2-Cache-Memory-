...
int mainmemory_size, cache_size, block_size;
...
(mainmemory / cache_size) =
tag;
(mainmemory % block_size) =
word;
((mainmemory / cache_size) % block_size) =
block;
